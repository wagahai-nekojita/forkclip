...
| [0006](0006-legacy-ciphertext-reencryption-plan.md) | Legacy Ciphertext Re-Encryption Plan | Accepted | Implemented in schema 12. Item, Display Title, and payload ciphertext are rewritten transactionally; removing the migration-only compatibility decryptor remains deferred. |
...
| [0011](0011-clipboard-security-resource-bounds.md) | Clipboard Resource and Identity Bounds | Accepted | Implemented. Capture, thumbnail, persistence, quota, source identity, Auto Paste, retention decoding, and legacy ciphertext migration boundaries are enforced and tested. |
...
4. [0011: Clipboard Resource and Identity Bounds](0011-clipboard-security-resource-bounds.md)
